        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoginText = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppType = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    TokenType = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    TenantId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClientId = table.Column<int>(type: "int", nullable: false),
                    AllowedGrantType = table.Column<int>(type: "int", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Clients",
                columns: new[] { "TenantId", "AppType", "TokenType", "IsActive", "ClientName" });
