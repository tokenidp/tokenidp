...
__export(index_exports, {
  ...
  IdpAuthProvider: () => IdpAuthProvider,
  LoginPage: () => LoginPage,
...
function IdpAuthProvider({ children, config }) {
  ...
  const refreshInFlightRef = (0, import_react.useRef)(false);
  ...
  return /* @__PURE__ */ import_react.default.createElement(AuthContext.Provider, { value: api }, children);
}
function useAuth() {
...
function renderLogoContent(logo, logoAlt, fallback) {
  if (!logo) {
    return /* @__PURE__ */ import_react2.default.createElement("div", { className: "logo mb-3" }, fallback);
  }
  if (typeof logo === "string") {
    return /* @__PURE__ */ import_react2.default.createElement("div", { className: "mb-3" }, /* @__PURE__ */ import_react2.default.createElement("img", { src: logo, alt: logoAlt, width: "250" }));
  }
  return /* @__PURE__ */ import_react2.default.createElement("div", { className: "mb-3" }, logo);
}
function AuthCallback({
  ...
  const ranRef = (0, import_react2.useRef)(false);
  ...
  return /* @__PURE__ */ import_react2.default.createElement("div", { className: "login-page" }, /* @__PURE__ */ import_react2.default.createElement("section", { className: "login-section-container" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "login-section redirect-card" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "col-12 p-4 text-center" }, renderLogoContent(logo, logoAlt, fallbackBadge), /* @__PURE__ */ import_react2.default.createElement("h1", null, "Completing sign-in"), /* @__PURE__ */ import_react2.default.createElement("p", { className: "text-muted" }, error ? error : "Please wait while we finish authentication.")))));
}
...
function renderLogoContent2(logo, logoAlt, fallback) {
  if (!logo) {
    return /* @__PURE__ */ import_react3.default.createElement("div", { className: "logo mb-3" }, fallback);
  }
  if (typeof logo === "string") {
    return /* @__PURE__ */ import_react3.default.createElement("div", { className: "mb-3" }, /* @__PURE__ */ import_react3.default.createElement("img", { src: logo, alt: logoAlt, width: "250" }));
  }
  return /* @__PURE__ */ import_react3.default.createElement("div", { className: "mb-3" }, logo);
}
function LoginPage({
  logo = null,
  logoAlt = "Application logo",
  ...
  if (isLoggedOut) {
    return /* @__PURE__ */ import_react3.default.createElement("div", { className: "login-page" }, /* @__PURE__ */ import_react3.default.createElement("section", { className: "login-section-container" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "login-section redirect-card" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "p-4 text-center" }, renderLogoContent2(logo, logoAlt, fallbackBadge), /* @__PURE__ */ import_react3.default.createElement("h1", null, signedOutTitle), /* @__PURE__ */ import_react3.default.createElement("p", { className: "text-muted" }, signedOutSubtitle), /* @__PURE__ */ import_react3.default.createElement(
      "button",
      {
  ...
  return /* @__PURE__ */ import_react3.default.createElement("div", { className: "login-page" }, /* @__PURE__ */ import_react3.default.createElement("section", { className: "login-section-container" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "login-section redirect-card" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "p-4 text-center" }, renderLogoContent2(logo, logoAlt, fallbackBadge), /* @__PURE__ */ import_react3.default.createElement("h1", null, title), /* @__PURE__ */ import_react3.default.createElement("p", { className: "text-muted" }, subtitle), /* @__PURE__ */ import_react3.default.createElement("div", { className: "spinner mt-3" })))));
}
