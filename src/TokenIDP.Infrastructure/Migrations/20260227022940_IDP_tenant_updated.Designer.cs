...
namespace TokenIDP.Infrastructure.Migrations
{
    ...
    [Migration("20260227022940_IDP_tenant_updated")]
    partial class IDP_tenant_updated
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TokenIDP.Domain.AggregateRoots.Clients.ClientAuthPolicy", b =>
                {
                    ...
                    b.HasOne("TokenIDP.Domain.AggregateRoots.Clients.Client", null)
                        .WithOne("ClientAuthPolicy")
                        .HasForeignKey("TokenIDP.Domain.AggregateRoots.Clients.ClientAuthPolicy", "ClientId1");
