...
internal sealed class EmailQueueRepository : IEmailQueueRepository
{
    private readonly ApplicationDbContext _db;
    private readonly IAppLogger<EmailQueueRepository> _logger;

    public EmailQueueRepository(ApplicationDbContext db, IAppLogger<EmailQueueRepository> logger)
    {
        _db = db;
        _logger = logger;
    }
