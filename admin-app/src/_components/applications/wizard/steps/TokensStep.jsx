      ...
      <div className="col-12 col-lg-8 col-xl-7">
        <div className="card">
          <div className="card-body">
            <h6 className="card-title">Token Settings</h6>
            ...
            <div className="token-section">
              <label className="form-label fw-semibold">Access Token Settings</label>
              ...
              <div className="form-text">
                Shorter lifetimes improve security. Typical values: 5-60 minutes.
              </div>
            </div>
            ...
            <div className="token-section">
              ...
              {!hasAuthCode && (
                <div className="form-text text-muted">
                  This setting applies only when the authorization_code grant is enabled.
                </div>
              )}
              ...
              <div className="form-text">
                Authorization codes should be short-lived (recommended \u2264 10 minutes).
              </div>
            </div>
            ...
            <div className="token-section">
              <label className="form-label fw-semibold">Refresh Token Settings</label>
              <div className="input-group">
                <span className="input-group-text">
              ...
              {!hasRefreshToken && (
                <div className="form-text text-muted">
                  This setting applies only when refresh tokens are enabled.
                </div>
              )}
