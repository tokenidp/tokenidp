...
internal sealed class GetClientLookupsUseCase
{
    private readonly ICache _cache;
    private readonly ICurrentUserService _currentUserService;
    private readonly IAppLogger<GetClientLookupsUseCase> _logger;

    public GetClientLookupsUseCase(
        ICache cache,
        ICurrentUserService currentUserService,
        IAppLogger<GetClientLookupsUseCase> logger)
    {
        _cache = cache;
