...
internal sealed class GetTenantLookupsUseCase
{
    private readonly ICache _cache;
    private readonly ICurrentUserService _currentUserService;
    private readonly IAppLogger<GetTenantLookupsUseCase> _logger;

    public GetTenantLookupsUseCase(
        ICache cache,
        ICurrentUserService currentUserService,
        IAppLogger<GetTenantLookupsUseCase> logger)
    {
        _cache = cache;
