...
internal class CreateUpdateRoleUseCase
{
    private readonly IApplicationDbContext _dbContext;
    private readonly IAppLogger<CreateUpdateRoleUseCase> _logger;
    private readonly ICurrentUserService _currentUserService;

    public CreateUpdateRoleUseCase(IAppLogger<CreateUpdateRoleUseCase> logger,
