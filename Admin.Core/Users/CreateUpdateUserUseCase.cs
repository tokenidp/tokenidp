...
internal class CreateUpdateUserUseCase
{
    private readonly UserManager<User> _userManager;
    private readonly ICurrentUserService _currentUserService;
    private readonly IApplicationDbContext _dbContext;
    private readonly IAppLogger<CreateUpdateUserUseCase> _logger;

    public CreateUpdateUserUseCase(ICurrentUserService currentUserService,
        UserManager<User> userManager,
        IApplicationDbContext applicationDbContext,
        IAppLogger<CreateUpdateUserUseCase> logger)
    {
