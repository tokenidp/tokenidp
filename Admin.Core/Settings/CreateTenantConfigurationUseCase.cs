...
internal sealed class CreateTenantConfigurationUseCase
{
    private readonly ITenantConfigurationRepository _repository;
    private readonly ICurrentUserService _currentUserService;
    private readonly IAppLogger<CreateTenantConfigurationUseCase> _logger;

    public CreateTenantConfigurationUseCase(
        ITenantConfigurationRepository repository,
        ICurrentUserService currentUserService,
        IAppLogger<CreateTenantConfigurationUseCase> logger)
    {
