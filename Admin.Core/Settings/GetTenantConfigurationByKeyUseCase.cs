...
internal sealed class GetTenantConfigurationByKeyUseCase
{
    private readonly ITenantConfigurationRepository _repository;
    private readonly ICurrentUserService _currentUserService;
    private readonly ICache _cache;
    private readonly IAppLogger<GetTenantConfigurationByKeyUseCase> _logger;

    public GetTenantConfigurationByKeyUseCase(
        ITenantConfigurationRepository repository,
        ICurrentUserService currentUserService,
        ICache cache,
        IAppLogger<GetTenantConfigurationByKeyUseCase> logger)
    {
