...
internal sealed class BulkUpdateTenantConfigurationsUseCase
{
    private readonly ITenantConfigurationRepository _repository;
    private readonly ICurrentUserService _currentUserService;
    private readonly ICache _cache;
    private readonly IAppLogger<BulkUpdateTenantConfigurationsUseCase> _logger;

    public BulkUpdateTenantConfigurationsUseCase(
        ITenantConfigurationRepository repository,
        ICurrentUserService currentUserService,
        ICache cache,
        IAppLogger<BulkUpdateTenantConfigurationsUseCase> logger)
    {
