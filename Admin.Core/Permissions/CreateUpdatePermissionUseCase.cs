...
internal class CreateUpdatePermissionUseCase
{
    private readonly IApplicationDbContext _dbContext;
    private readonly IAppLogger<CreateUpdatePermissionUseCase> _logger;
    private readonly ICurrentUserService _currentUserService;

    public CreateUpdatePermissionUseCase(IAppLogger<CreateUpdatePermissionUseCase> logger,
