...
internal class GetPermissionUseCase
{

    private readonly IApplicationDbContext _dbContext;
    private readonly IAppLogger<GetPermissionUseCase> _logger;
    private readonly ICurrentUserService _currentUserService;

    public GetPermissionUseCase(IAppLogger<GetPermissionUseCase> logger,
