...
public class MfaService : IDisposable
{
    protected readonly HttpClient _httpClient;
    protected readonly IAppLogger<MfaService> _logger;

    private bool _disposed;

    public MfaService(IHttpClientFactory httpClientFactory, IAppLogger<MfaService> logger)
    {
